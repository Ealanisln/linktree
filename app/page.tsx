...
function LinkCard({ 
  url, 
  name, 
  image }: { url:string; name:string; image?:string }) {
  return (
    <a 
      href={url} 
      className='bg-gray-100 flex items-center p-1 w-full rounded-md shadow-lg hover:scale-105 transition-all mb-3 max-w-2xl'>
        ...
        <div className="w-10 h-10">
          ...
          <h2 className='flex justify-center items-center font-semibold w-full text-slate-700	-ml-10'>{name}</h2>
        </div>
    </a>
  )
}
